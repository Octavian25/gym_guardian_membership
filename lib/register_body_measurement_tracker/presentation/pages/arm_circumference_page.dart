...
class ArmCirfumferenceRegisterBodymeasurement extends StatefulWidget {
  const ArmCirfumferenceRegisterBodymeasurement({super.key});

  @override
  State<ArmCirfumferenceRegisterBodymeasurement> createState() =>
      _ArmCirfumferenceRegisterBodymeasurementState();
}

class _ArmCirfumferenceRegisterBodymeasurementState
    extends State<ArmCirfumferenceRegisterBodymeasurement> {
  ValueNotifier<int> armNotifier = ValueNotifier(50);
